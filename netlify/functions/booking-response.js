...
function generateConfirmationPage(booking, therapist, action, bookingId, therapistId) {
  ...
  const baseAction = `/.netlify/functions/booking-response?booking=${bookingId}&therapist=${therapistId}`;
...
<head>
  <meta charset="UTF-8">
  <title>${isAccept ? 'Accept' : 'Decline'} Booking - Rejuvenators</title>
