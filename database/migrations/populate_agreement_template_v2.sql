-- =====================================================
-- POPULATE AGREEMENT TEMPLATE WITH V2 CONTENT
-- =====================================================
...
-- Delete the placeholder v1.0 template
DELETE FROM public.agreement_templates WHERE version = 'v1.0';

-- Insert the actual V2 agreement template
INSERT INTO public.agreement_templates (
  ...
  -- Full HTML content for display in registration form
  '<div class="agreement-document">
    ...
    <div class="agreement-section">
      ...
      <ul>
        ...
        <li><strong>Payment:</strong> 55% of Job Recommended Retail Price (see website)</li>
    ...
    <div class="agreement-notice">
      ...
      <ul>
        ...
        <li>You have read the ENTIRE 16-page agreement (or chosen to waive legal advice)</li>
        <li>All information you provided is accurate and complete</li>
      </ul>
    </div>

    <div class="agreement-footer">
      <p><em>This summary covers the key points. The full 16-page agreement contains additional legal terms, definitions, and conditions. Please download and review the complete PDF document.</em></p>
    </div>
  </div>',

  -- PDF URL in Supabase Storage
  -- IMPORTANT: Update [YOUR-PROJECT-REF] with your actual Supabase project reference
  'https://[YOUR-PROJECT-REF].supabase.co/storage/v1/object/public/Legal%20Agreements/Rejuvenators%20Mobile%20Massage%20-Independent%20Contractor%20Agreement%20V2.pdf',
  ...
  '{
    "key_terms": [
      ...
      "Payment: 55% of Job RRP as per website",
...
-- 2. Find the file: "Rejuvenators Mobile Massage -Independent Contractor Agreement V2.pdf"
...
-- Example URL format:
-- https://abcdefghijk.supabase.co/storage/v1/object/public/Legal%20Agreements/Rejuvenators%20Mobile%20Massage%20-Independent%20Contractor%20Agreement%20V2.pdf
