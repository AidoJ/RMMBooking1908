    ...
    >
      {!centerLat || !centerLng ? (
        <Alert
          ...
          description="Please verify the home address above first. The service area will be drawn around the verified location."
          type="warning"
          showIcon
      ...
      <div style={{ marginTop: '16px', fontSize: '12px', color: '#666' }}>
        ...
        <ul style={{ marginTop: '8px', marginBottom: 0 }}>
          ...
          <li>The service radius field will remain as a fallback for backwards compatibility</li>
        </ul>
      </div>
    </Card>
  );
